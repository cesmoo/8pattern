...
async def init_db():
    try:
        ...
        print("🗄 MongoDB ချိတ်ဆက်မှု အောင်မြင်ပါသည်။ (🚀 25s Fixed Trigger System)")
...
async def send_welcome(message: types.Message):
    await message.reply("👋 မင်္ဂလာပါ။ စနစ်က 25s Remaining Trigger ပုံစံဖြင့် အလုပ်လုပ်နေပါပြီ။")

async def main():
    print("🚀 Aiogram Bigwin Bot (25s Trigger AI) စတင်နေပါပြီ...\n")
